...
#define R8_CHIP_ID (*((volatile uint8_t*)0x40001041)) // RF, chip ID register, always is ID_CH57*
#define R8_SAFE_ACCESS_ID (*((volatile uint8_t*)0x40001042)) // RF, safe accessing ID register, always 0x04
...
#define R8_AUX_POWER_ADJ (*((volatile uint8_t*)0x40001022)) // RWA, aux power adjust control, SAM
...
#define R16_OSC_CAL_CNT (*((volatile uint16_t*)0x40001050)) // RO, system clock count value for 32KHz 5 cycles
#define RB_OSC_CAL_CNT 0x3FFF // RO, system clock count value for 32KHz 5 cycles
#define R8_OSC_CAL_CTRL (*((volatile uint8_t*)0x40001052)) // RWA, oscillator frequency calibration control, SAM
