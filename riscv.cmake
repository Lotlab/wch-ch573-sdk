...
if (NOT EXISTS ${RISCV_GCC_COMPILER})
	...
	FIND_FILE( RISCV_GITHUB_GCC_COMPILER_EXE "riscv32-unknown-elf-gcc.exe" PATHS ENV INCLUDE)
	FIND_FILE( RISCV_GITHUB_GCC_COMPILER "riscv32-unknown-elf-gcc" PATHS ENV INCLUDE)
...
set(CMAKE_ASM_COMPILER ${RISCV_TOOLCHAIN_BIN_PATH}/${CROSS_COMPILE}gcc${RISCV_TOOLCHAIN_BIN_EXT} )
set(CMAKE_AR ${RISCV_TOOLCHAIN_BIN_PATH}/${CROSS_COMPILE}ar${RISCV_TOOLCHAIN_BIN_EXT})
set(CMAKE_ASM_COMPILER ${RISCV_TOOLCHAIN_BIN_PATH}/${CROSS_COMPILE}gcc${RISCV_TOOLCHAIN_BIN_EXT})
set(CMAKE_C_COMPILER ${RISCV_TOOLCHAIN_BIN_PATH}/${CROSS_COMPILE}gcc${RISCV_TOOLCHAIN_BIN_EXT})
set(CMAKE_CXX_COMPILER ${RISCV_TOOLCHAIN_BIN_PATH}/${CROSS_COMPILE}g++${RISCV_TOOLCHAIN_BIN_EXT})
